...
public class AyTrackFilter extends LazyFilter {
  ...
  private int min_face_size = 40; // smaller face, longer detection time

  public AyTrackFilter(Context context) {
    mTracker = new AiyaTracker(context, min_face_size);
  }
  ...
  public void draw(int texture) {
    ...
    super.draw(texture);
    GLES20.glReadPixels(
        0, 0, mTrackWidth, mTrackHeight, GLES20.GL_RGBA, GLES20.GL_UNSIGNED_BYTE, mTrackBuffer);
