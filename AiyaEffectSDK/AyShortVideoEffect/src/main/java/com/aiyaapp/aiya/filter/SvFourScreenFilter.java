...
/**
 * SvFourScreenFilter 四分屏
 *
 * @author wuwang
 * @version v1.0 2017:11:07 15:37
 */
public class SvFourScreenFilter extends BaseShortVideoFilter {
    ...
    public SvFourScreenFilter() {
        super(AiyaShaderEffect.TYPE_FOUR_SCREEN);
    }

    @Override
    protected void onSizeChanged(int width, int height) {
        super.onSizeChanged(width, height);
        AiyaShaderEffect.nSet(nativeObjId,"Interval",45);
    }
    ...
    private void beforeDraw(int texture){
        if(tempTextures!=null){
            ...
            if(!hasInit){
                ...
                AiyaShaderEffect.nSet(nativeObjId,"SubWindow",2);
